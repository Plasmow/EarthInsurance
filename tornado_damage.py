...
def train_damage(
	...
	reg_f.fit(X_tr, y_f_tr, eval_set=[(X_te, y_f_te)], verbose=False, early_stopping_rounds=300)
	...
	reg_w.fit(X_tr, y_w_tr, eval_set=[(X_te, y_w_te)], verbose=False, early_stopping_rounds=300)
